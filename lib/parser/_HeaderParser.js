module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c45 = { type: "other", description: "wildcard" },
        peg$c46 = function(result) { return IntermediateRepresentation.wildcard(result); },
        peg$c47 = function(result) { return IntermediateRepresentation.literal(result); },
        peg$c48 = "null",
        peg$c49 = { type: "literal", value: "null", description: "\"null\"" },
        peg$c50 = { type: "other", description: "boolean" },
        peg$c51 = "true",
        ...
        peg$c57 = null,
        peg$c58 = function(integer, remainder) {
            var intPart     = integer;
        ...
        peg$c60 = function(str) { return str[1].join(""); },
        peg$c61 = "\\",
        peg$c62 = { type: "literal", value: "\\", description: "\"\\\\\"" },
        peg$c63 = { type: "any", description: "any character" },
        peg$c64 = function(char) { return char.join(""); },
        peg$c65 = { type: "other", description: "date" },
        peg$c66 = "-",
        peg$c67 = { type: "literal", value: "-", description: "\"-\"" },
        peg$c68 = function(year, month, day, time) {
            time = time || [0, 0, 0, 0, 0];
        ...
        peg$c69 = function(result) { return parseInt(result.join(""), 10); },
        peg$c70 = /^[1-9]/,
        peg$c71 = { type: "class", value: "[1-9]", description: "[1-9]" },
        peg$c72 = ":",
        peg$c73 = { type: "literal", value: ":", description: "\":\"" },
        peg$c74 = function(nested_select) { return IntermediateRepresentation.access_array(nested_select); },
        peg$c75 = function(result) { return IntermediateRepresentation.access_dot(result); },
        peg$c76 = function(result) { return IntermediateRepresentation.access_dot([result]); },
        peg$c77 = function(result) { return IntermediateRepresentation.access_extended(result); },
        peg$c78 = function(base, dot_access) { return IntermediateRepresentation.selector_base(base, dot_access); },
        peg$c79 = function(base, extended_access) { return IntermediateRepresentation.selector_extended(base, extended_access); },
        peg$c80 = { type: "other", description: "selector" },
        peg$c81 = function(result) { return IntermediateRepresentation.selector(result); },
        peg$c82 = function(first, more) { return IntermediateRepresentation.values(argumentsList(first, more)); },
        peg$c83 = { type: "other", description: "array" },
        peg$c84 = function(items) { return IntermediateRepresentation.arr(items); },
        peg$c85 = function(id, params) { return IntermediateRepresentation.func(id, params); },
        peg$c86 = function(single, more) { return IntermediateRepresentation.select(argumentsList(single, more)); },
        peg$c87 = function(alias, agg) { return IntermediateRepresentation.selectItem(alias, agg) },
        peg$c88 = function(single, more) { return IntermediateRepresentation.filter(argumentsList(single, more)); },
        peg$c89 = function(single, more) { return IntermediateRepresentation.order(argumentsList(single, more)); },
        peg$c90 = function(base, direction) { return IntermediateRepresentation.order_item(base, direction); },
        peg$c91 = function(compared, operator, val) { return IntermediateRepresentation.comp(compared, operator, val); },
        peg$c92 = "!=",
        ...
        peg$c102 = "like",
        peg$c103 = { type: "literal", value: "like", description: "\"like\"" },
        peg$c104 = function(op) { return op.toUpperCase(); },
        peg$c105 = "=",
