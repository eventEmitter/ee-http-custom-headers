module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c78 = function(base, dot_access, extended_access) { return IntermediateRepresentation.selector_base(base, dot_access, extended_access); },
        peg$c79 = { type: "other", description: "selector" },
        peg$c80 = function(result) { return IntermediateRepresentation.selector(result); },
        peg$c81 = function(first, more) { return IntermediateRepresentation.values(argumentsList(first, more)); },
        peg$c82 = { type: "other", description: "array" },
        peg$c83 = function(items) { return IntermediateRepresentation.arr(items); },
        peg$c84 = function(id, params) { return IntermediateRepresentation.func(id, params); },
        peg$c85 = function(single, more) { return IntermediateRepresentation.select(argumentsList(single, more)); },
        peg$c86 = function(alias, agg) { return IntermediateRepresentation.selectItem(alias, agg) },
        peg$c87 = function(single, more) { return IntermediateRepresentation.filter(argumentsList(single, more)); },
        peg$c88 = function(single, more) { return IntermediateRepresentation.order(argumentsList(single, more)); },
        peg$c89 = function(compared, operator, val) { return IntermediateRepresentation.comp(compared, operator, val); },
        peg$c90 = "!=",
        ...
        peg$c100 = "like",
        peg$c101 = { type: "literal", value: "like", description: "\"like\"" },
        peg$c102 = function(op) { return op.toUpperCase(); },
        peg$c103 = "=",
