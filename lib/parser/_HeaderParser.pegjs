...
access_dot                  = dot name:identifier accesses:access_dot?  { return IntermediateRepresentation.access_dot(name, accesses); }
access_wildcard             = dot wildcard:star                         { return IntermediateRepresentation.access_dot(wildcard); }
access_extended             = result:(access_wildcard / access_array)   { return IntermediateRepresentation.access_extended(result); }

selector_base               = baseName:identifier accessDot:access_dot? { return IntermediateRepresentation.selector_base(baseName, accessDot); }
selector "selector"         = result:(selector_base access_extended?)   { return IntermediateRepresentation.selector(result); }
...
order_item      = function / selector_base
