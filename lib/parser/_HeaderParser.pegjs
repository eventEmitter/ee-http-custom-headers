...
selector_base               = base:identifier dot_access:access_dot extended_access:access_extended?   { return IntermediateRepresentation.selector_base(base, dot_access, extended_access); }
selector "selector"         = result:(selector_base / wildcard)                                        { return IntermediateRepresentation.selector(result); }
